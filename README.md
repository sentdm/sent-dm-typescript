...
[![NPM version](<https://img.shields.io/npm/v/sent_dm.svg?label=npm%20(stable)>)](https://npmjs.org/package/sent_dm) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/sent_dm)
...
```ts
import SentDm from 'npm:sent_dm';
