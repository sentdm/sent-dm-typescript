...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    response:
      '{ data?: { id?: string; consecutive_failures?: number; created_at?: string; display_name?: string; endpoint_url?: string; event_filters?: object; event_types?: string[]; is_active?: boolean; last_delivery_attempt_at?: string; last_successful_delivery_at?: string; retry_count?: number; signing_secret?: string; timeout_seconds?: number; updated_at?: string; }; error?: { code?: string; details?: object; doc_url?: string; message?: string; }; meta?: { request_id?: string; timestamp?: string; version?: string; }; success?: boolean; }',
    markdown:
      "## retrieve\n\n`client.webhooks.retrieve(id: string, x-profile-id?: string): { data?: object; error?: object; meta?: object; success?: boolean; }`\n\n**get** `/v3/webhooks/{id}`\n\nRetrieves a single webhook by ID for the authenticated customer.\n\n### Parameters\n\n- `id: string`\n\n- `x-profile-id?: string`\n\n### Returns\n\n- `{ data?: { id?: string; consecutive_failures?: number; created_at?: string; display_name?: string; endpoint_url?: string; event_filters?: object; event_types?: string[]; is_active?: boolean; last_delivery_attempt_at?: string; last_successful_delivery_at?: string; retry_count?: number; signing_secret?: string; timeout_seconds?: number; updated_at?: string; }; error?: { code?: string; details?: object; doc_url?: string; message?: string; }; meta?: { request_id?: string; timestamp?: string; version?: string; }; success?: boolean; }`\n  Standard API response envelope for all v3 endpoints\n\n  - `data?: { id?: string; consecutive_failures?: number; created_at?: string; display_name?: string; endpoint_url?: string; event_filters?: object; event_types?: string[]; is_active?: boolean; last_delivery_attempt_at?: string; last_successful_delivery_at?: string; retry_count?: number; signing_secret?: string; timeout_seconds?: number; updated_at?: string; }`\n  - `error?: { code?: string; details?: object; doc_url?: string; message?: string; }`\n  - `meta?: { request_id?: string; timestamp?: string; version?: string; }`\n  - `success?: boolean`\n\n### Example\n\n```typescript\nimport Sent from '@sentdm/sentdm';\n\nconst client = new Sent();\n\nconst webhook = await client.webhooks.retrieve('d4f5a6b7-c8d9-4e0f-a1b2-c3d4e5f6a7b8');\n\nconsole.log(webhook);\n```",
    perLanguage: {
      typescript: {
      ...
      ruby: {
        method: 'webhooks.retrieve',
        example:
          'require "sentdm"\n\nsent = Sentdm::Client.new(api_key: "My API Key")\n\nwebhook = sent.webhooks.retrieve("d4f5a6b7-c8d9-4e0f-a1b2-c3d4e5f6a7b8")\n\nputs(webhook)',
      },
      php: {
        method: 'webhooks->retrieve',
        example:
      ...
      csharp: {
        method: 'Webhooks.Retrieve',
        example:
          'WebhookRetrieveParams parameters = new()\n{\n    ID = "d4f5a6b7-c8d9-4e0f-a1b2-c3d4e5f6a7b8"\n};\n\nvar webhook = await client.Webhooks.Retrieve(parameters);\n\nConsole.WriteLine(webhook);',
      },
      http: {
  ...
  },
  {
    ...
    response:
      '{ data?: { id?: string; consecutive_failures?: number; created_at?: string; display_name?: string; endpoint_url?: string; event_filters?: object; event_types?: string[]; is_active?: boolean; last_delivery_attempt_at?: string; last_successful_delivery_at?: string; retry_count?: number; signing_secret?: string; timeout_seconds?: number; updated_at?: string; }; error?: { code?: string; details?: object; doc_url?: string; message?: string; }; meta?: { request_id?: string; timestamp?: string; version?: string; }; success?: boolean; }',
    markdown:
      "## update\n\n`client.webhooks.update(id: string, display_name?: string, endpoint_url?: string, event_filters?: object, event_types?: string[], retry_count?: number, sandbox?: boolean, timeout_seconds?: number, Idempotency-Key?: string, x-profile-id?: string): { data?: object; error?: object; meta?: object; success?: boolean; }`\n\n**put** `/v3/webhooks/{id}`\n\nUpdates an existing webhook for the authenticated customer.\n\n### Parameters\n\n- `id: string`\n\n- `display_name?: string`\n\n- `endpoint_url?: string`\n\n- `event_filters?: object`\n\n- `event_types?: string[]`\n\n- `retry_count?: number`\n\n- `sandbox?: boolean`\n  Sandbox flag - when true, the operation is simulated without side effects\nUseful for testing integrations without actual execution\n\n- `timeout_seconds?: number`\n\n- `Idempotency-Key?: string`\n\n- `x-profile-id?: string`\n\n### Returns\n\n- `{ data?: { id?: string; consecutive_failures?: number; created_at?: string; display_name?: string; endpoint_url?: string; event_filters?: object; event_types?: string[]; is_active?: boolean; last_delivery_attempt_at?: string; last_successful_delivery_at?: string; retry_count?: number; signing_secret?: string; timeout_seconds?: number; updated_at?: string; }; error?: { code?: string; details?: object; doc_url?: string; message?: string; }; meta?: { request_id?: string; timestamp?: string; version?: string; }; success?: boolean; }`\n  Standard API response envelope for all v3 endpoints\n\n  - `data?: { id?: string; consecutive_failures?: number; created_at?: string; display_name?: string; endpoint_url?: string; event_filters?: object; event_types?: string[]; is_active?: boolean; last_delivery_attempt_at?: string; last_successful_delivery_at?: string; retry_count?: number; signing_secret?: string; timeout_seconds?: number; updated_at?: string; }`\n  - `error?: { code?: string; details?: object; doc_url?: string; message?: string; }`\n  - `meta?: { request_id?: string; timestamp?: string; version?: string; }`\n  - `success?: boolean`\n\n### Example\n\n```typescript\nimport Sent from '@sentdm/sentdm';\n\nconst client = new Sent();\n\nconst webhook = await client.webhooks.update('d4f5a6b7-c8d9-4e0f-a1b2-c3d4e5f6a7b8');\n\nconsole.log(webhook);\n```",
    perLanguage: {
      typescript: {
      ...
      ruby: {
        method: 'webhooks.update',
        example:
          'require "sentdm"\n\nsent = Sentdm::Client.new(api_key: "My API Key")\n\nwebhook = sent.webhooks.update("d4f5a6b7-c8d9-4e0f-a1b2-c3d4e5f6a7b8")\n\nputs(webhook)',
      },
      php: {
        method: 'webhooks->update',
        example:
      ...
      csharp: {
        method: 'Webhooks.Update',
        example:
          'WebhookUpdateParams parameters = new()\n{\n    ID = "d4f5a6b7-c8d9-4e0f-a1b2-c3d4e5f6a7b8"\n};\n\nvar webhook = await client.Webhooks.Update(parameters);\n\nConsole.WriteLine(webhook);',
      },
      http: {
        example:
  ...
  },
  {
    ...
    markdown:
      "## rotate_secret\n\n`client.webhooks.rotateSecret(id: string, sandbox?: boolean, Idempotency-Key?: string, x-profile-id?: string): { data?: object; error?: object; meta?: object; success?: boolean; }`\n\n**post** `/v3/webhooks/{id}/rotate-secret`\n\nGenerates a new signing secret for the specified webhook. The old secret is immediately invalidated.\n\n### Parameters\n\n- `id: string`\n\n- `sandbox?: boolean`\n  Sandbox flag - when true, the operation is simulated without side effects\nUseful for testing integrations without actual execution\n\n- `Idempotency-Key?: string`\n\n- `x-profile-id?: string`\n\n### Returns\n\n- `{ data?: { signing_secret?: string; }; error?: { code?: string; details?: object; doc_url?: string; message?: string; }; meta?: { request_id?: string; timestamp?: string; version?: string; }; success?: boolean; }`\n  Standard API response envelope for all v3 endpoints\n\n  - `data?: { signing_secret?: string; }`\n  - `error?: { code?: string; details?: object; doc_url?: string; message?: string; }`\n  - `meta?: { request_id?: string; timestamp?: string; version?: string; }`\n  - `success?: boolean`\n\n### Example\n\n```typescript\nimport Sent from '@sentdm/sentdm';\n\nconst client = new Sent();\n\nconst response = await client.webhooks.rotateSecret('d4f5a6b7-c8d9-4e0f-a1b2-c3d4e5f6a7b8');\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      '{ data?: { id?: string; consecutive_failures?: number; created_at?: string; display_name?: string; endpoint_url?: string; event_filters?: object; event_types?: string[]; is_active?: boolean; last_delivery_attempt_at?: string; last_successful_delivery_at?: string; retry_count?: number; signing_secret?: string; timeout_seconds?: number; updated_at?: string; }; error?: { code?: string; details?: object; doc_url?: string; message?: string; }; meta?: { request_id?: string; timestamp?: string; version?: string; }; success?: boolean; }',
    markdown:
      "## toggle_status\n\n`client.webhooks.toggleStatus(id: string, is_active?: boolean, sandbox?: boolean, Idempotency-Key?: string, x-profile-id?: string): { data?: object; error?: object; meta?: object; success?: boolean; }`\n\n**patch** `/v3/webhooks/{id}/toggle-status`\n\nActivates or deactivates a webhook for the authenticated customer.\n\n### Parameters\n\n- `id: string`\n\n- `is_active?: boolean`\n\n- `sandbox?: boolean`\n  Sandbox flag - when true, the operation is simulated without side effects\nUseful for testing integrations without actual execution\n\n- `Idempotency-Key?: string`\n\n- `x-profile-id?: string`\n\n### Returns\n\n- `{ data?: { id?: string; consecutive_failures?: number; created_at?: string; display_name?: string; endpoint_url?: string; event_filters?: object; event_types?: string[]; is_active?: boolean; last_delivery_attempt_at?: string; last_successful_delivery_at?: string; retry_count?: number; signing_secret?: string; timeout_seconds?: number; updated_at?: string; }; error?: { code?: string; details?: object; doc_url?: string; message?: string; }; meta?: { request_id?: string; timestamp?: string; version?: string; }; success?: boolean; }`\n  Standard API response envelope for all v3 endpoints\n\n  - `data?: { id?: string; consecutive_failures?: number; created_at?: string; display_name?: string; endpoint_url?: string; event_filters?: object; event_types?: string[]; is_active?: boolean; last_delivery_attempt_at?: string; last_successful_delivery_at?: string; retry_count?: number; signing_secret?: string; timeout_seconds?: number; updated_at?: string; }`\n  - `error?: { code?: string; details?: object; doc_url?: string; message?: string; }`\n  - `meta?: { request_id?: string; timestamp?: string; version?: string; }`\n  - `success?: boolean`\n\n### Example\n\n```typescript\nimport Sent from '@sentdm/sentdm';\n\nconst client = new Sent();\n\nconst response = await client.webhooks.toggleStatus('d4f5a6b7-c8d9-4e0f-a1b2-c3d4e5f6a7b8');\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
      ...
      python: {
        ...
        example:
          'import os\nfrom sent_dm import Sent\n\nclient = Sent(\n    api_key=os.environ.get("SENT_DM_API_KEY"),  # This is the default and can be omitted\n)\nresponse = client.webhooks.toggle_status(\n    id="d4f5a6b7-c8d9-4e0f-a1b2-c3d4e5f6a7b8",\n)\nprint(response.data)',
      },
      java: {
        method: 'webhooks().toggleStatus',
        example:
          'package dm.sent.example;\n\nimport dm.sent.client.SentClient;\nimport dm.sent.client.okhttp.SentOkHttpClient;\nimport dm.sent.models.webhooks.WebhookToggleStatusParams;\nimport dm.sent.models.webhooks.WebhookToggleStatusResponse;\n\npublic final class Main {\n    private Main() {}\n\n    public static void main(String[] args) {\n        SentClient client = SentOkHttpClient.fromEnv();\n\n        WebhookToggleStatusResponse response = client.webhooks().toggleStatus("d4f5a6b7-c8d9-4e0f-a1b2-c3d4e5f6a7b8");\n    }\n}',
      },
      go: {
        method: 'client.Webhooks.ToggleStatus',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/sentdm/sent-dm-go"\n\t"github.com/sentdm/sent-dm-go/option"\n)\n\nfunc main() {\n\tclient := sentdm.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tresponse, err := client.Webhooks.ToggleStatus(\n\t\tcontext.TODO(),\n\t\t"d4f5a6b7-c8d9-4e0f-a1b2-c3d4e5f6a7b8",\n\t\tsentdm.WebhookToggleStatusParams{},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", response.Data)\n}\n',
      },
      ruby: {
        method: 'webhooks.toggle_status',
        example:
      ...
      php: {
        method: 'webhooks->toggleStatus',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client(apiKey: 'My API Key');\n\n$response = $client->webhooks->toggleStatus(\n  'd4f5a6b7-c8d9-4e0f-a1b2-c3d4e5f6a7b8',\n  isActive: false,\n  sandbox: false,\n  idempotencyKey: 'req_abc123_retry1',\n  xProfileID: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',\n);\n\nvar_dump($response);",
      },
      csharp: {
        method: 'Webhooks.ToggleStatus',
        example:
          'WebhookToggleStatusParams parameters = new()\n{\n    ID = "d4f5a6b7-c8d9-4e0f-a1b2-c3d4e5f6a7b8"\n};\n\nvar response = await client.Webhooks.ToggleStatus(parameters);\n\nConsole.WriteLine(response);',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'users.retrieve',
        example:
          'require "sentdm"\n\nsent = Sentdm::Client.new(api_key: "My API Key")\n\nuser = sent.users.retrieve("userId")\n\nputs(user)',
      },
      php: {
        method: 'users->retrieve',
        example:
  ...
  },
  {
    ...
    response:
      '{ data?: { id?: string; created_at?: string; email?: string; invited_at?: string; last_login_at?: string; name?: string; role?: string; status?: string; updated_at?: string; }; error?: { code?: string; details?: object; doc_url?: string; message?: string; }; meta?: { request_id?: string; timestamp?: string; version?: string; }; success?: boolean; }',
    markdown:
      "## update_role\n\n`client.users.updateRole(userId: string, role?: string, sandbox?: boolean, Idempotency-Key?: string, x-profile-id?: string): { data?: object; error?: object; meta?: object; success?: boolean; }`\n\n**patch** `/v3/users/{userId}`\n\nUpdates a user's role in the organization or profile. Requires admin role. You cannot change your own role or demote the last admin.\n\n### Parameters\n\n- `userId: string`\n\n- `role?: string`\n  User role: admin, billing, or developer (required)\n\n- `sandbox?: boolean`\n  Sandbox flag - when true, the operation is simulated without side effects\nUseful for testing integrations without actual execution\n\n- `Idempotency-Key?: string`\n\n- `x-profile-id?: string`\n\n### Returns\n\n- `{ data?: { id?: string; created_at?: string; email?: string; invited_at?: string; last_login_at?: string; name?: string; role?: string; status?: string; updated_at?: string; }; error?: { code?: string; details?: object; doc_url?: string; message?: string; }; meta?: { request_id?: string; timestamp?: string; version?: string; }; success?: boolean; }`\n  Standard API response envelope for all v3 endpoints\n\n  - `data?: { id?: string; created_at?: string; email?: string; invited_at?: string; last_login_at?: string; name?: string; role?: string; status?: string; updated_at?: string; }`\n  - `error?: { code?: string; details?: object; doc_url?: string; message?: string; }`\n  - `meta?: { request_id?: string; timestamp?: string; version?: string; }`\n  - `success?: boolean`\n\n### Example\n\n```typescript\nimport Sent from '@sentdm/sentdm';\n\nconst client = new Sent();\n\nconst response = await client.users.updateRole('userId');\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
      ...
      php: {
        method: 'users->updateRole',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client(apiKey: 'My API Key');\n\n$response = $client->users->updateRole(\n  'userId',\n  role: 'billing',\n  sandbox: false,\n  idempotencyKey: 'req_abc123_retry1',\n  xProfileID: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',\n);\n\nvar_dump($response);",
      },
      csharp: {
        method: 'Users.UpdateRole',
        example:
          'UserUpdateRoleParams parameters = new() { UserID = "userId" };\n\nvar response = await client.Users.UpdateRole(parameters);\n\nConsole.WriteLine(response);',
      },
      http: {
        example:
          'curl https://api.sent.dm/v3/users/$USER_ID \\\n    -X PATCH \\\n    -H \'Content-Type: application/json\' \\\n    -H "x-api-key: $SENT_DM_API_KEY" \\\n    -d \'{\n          "role": "billing",\n          "sandbox": false\n        }\'',
  ...
  },
  {
    ...
    params: ['x-profile-id?: string;'],
    response:
      '{ data?: { users?: { id?: string; created_at?: string; email?: string; invited_at?: string; last_login_at?: string; name?: string; role?: string; status?: string; updated_at?: string; }[]; }; error?: { code?: string; details?: object; doc_url?: string; message?: string; }; meta?: { request_id?: string; timestamp?: string; version?: string; }; success?: boolean; }',
    markdown:
      "## list\n\n`client.users.list(x-profile-id?: string): { data?: object; error?: object; meta?: object; success?: boolean; }`\n\n**get** `/v3/users`\n\nRetrieves all users who have access to the organization or profile identified by the API key, including their roles and status. Shows invited users (pending acceptance) and active users. Requires developer role or higher.\n\n### Parameters\n\n- `x-profile-id?: string`\n\n### Returns\n\n- `{ data?: { users?: { id?: string; created_at?: string; email?: string; invited_at?: string; last_login_at?: string; name?: string; role?: string; status?: string; updated_at?: string; }[]; }; error?: { code?: string; details?: object; doc_url?: string; message?: string; }; meta?: { request_id?: string; timestamp?: string; version?: string; }; success?: boolean; }`\n  Standard API response envelope for all v3 endpoints\n\n  - `data?: { users?: { id?: string; created_at?: string; email?: string; invited_at?: string; last_login_at?: string; name?: string; role?: string; status?: string; updated_at?: string; }[]; }`\n  - `error?: { code?: string; details?: object; doc_url?: string; message?: string; }`\n  - `meta?: { request_id?: string; timestamp?: string; version?: string; }`\n  - `success?: boolean`\n\n### Example\n\n```typescript\nimport Sent from '@sentdm/sentdm';\n\nconst client = new Sent();\n\nconst users = await client.users.list();\n\nconsole.log(users);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      '{ data?: { id?: string; created_at?: string; email?: string; invited_at?: string; last_login_at?: string; name?: string; role?: string; status?: string; updated_at?: string; }; error?: { code?: string; details?: object; doc_url?: string; message?: string; }; meta?: { request_id?: string; timestamp?: string; version?: string; }; success?: boolean; }',
    markdown:
      "## invite\n\n`client.users.invite(email?: string, name?: string, role?: string, sandbox?: boolean, Idempotency-Key?: string, x-profile-id?: string): { data?: object; error?: object; meta?: object; success?: boolean; }`\n\n**post** `/v3/users`\n\nSends an invitation to a user to join the organization or profile with a specific role. Requires admin role. The user will receive an invitation email with a token to accept. Invitation tokens expire after 7 days.\n\n### Parameters\n\n- `email?: string`\n  User email address (required)\n\n- `name?: string`\n  User full name (required)\n\n- `role?: string`\n  User role: admin, billing, or developer (required)\n\n- `sandbox?: boolean`\n  Sandbox flag - when true, the operation is simulated without side effects\nUseful for testing integrations without actual execution\n\n- `Idempotency-Key?: string`\n\n- `x-profile-id?: string`\n\n### Returns\n\n- `{ data?: { id?: string; created_at?: string; email?: string; invited_at?: string; last_login_at?: string; name?: string; role?: string; status?: string; updated_at?: string; }; error?: { code?: string; details?: object; doc_url?: string; message?: string; }; meta?: { request_id?: string; timestamp?: string; version?: string; }; success?: boolean; }`\n  Standard API response envelope for all v3 endpoints\n\n  - `data?: { id?: string; created_at?: string; email?: string; invited_at?: string; last_login_at?: string; name?: string; role?: string; status?: string; updated_at?: string; }`\n  - `error?: { code?: string; details?: object; doc_url?: string; message?: string; }`\n  - `meta?: { request_id?: string; timestamp?: string; version?: string; }`\n  - `success?: boolean`\n\n### Example\n\n```typescript\nimport Sent from '@sentdm/sentdm';\n\nconst client = new Sent();\n\nconst response = await client.users.invite();\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
      ...
      java: {
        method: 'users().invite',
        example:
          'package dm.sent.example;\n\nimport dm.sent.client.SentClient;\nimport dm.sent.client.okhttp.SentOkHttpClient;\nimport dm.sent.models.users.UserInviteParams;\nimport dm.sent.models.users.UserInviteResponse;\n\npublic final class Main {\n    private Main() {}\n\n    public static void main(String[] args) {\n        SentClient client = SentOkHttpClient.fromEnv();\n\n        UserInviteResponse response = client.users().invite();\n    }\n}',
      },
      go: {
        method: 'client.Users.Invite',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/sentdm/sent-dm-go"\n\t"github.com/sentdm/sent-dm-go/option"\n)\n\nfunc main() {\n\tclient := sentdm.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tresponse, err := client.Users.Invite(context.TODO(), sentdm.UserInviteParams{})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", response.Data)\n}\n',
      },
      ruby: {
        method: 'users.invite',
        example:
      ...
      csharp: {
        method: 'Users.Invite',
        example:
          'UserInviteParams parameters = new();\n\nvar response = await client.Users.Invite(parameters);\n\nConsole.WriteLine(response);',
      },
      http: {
        example:
  ...
  },
  {
    ...
    params: [
      ...
      'definition?: { body: { multiChannel?: { template: string; type?: string; variables?: { name: string; props: object; type: string; id?: number; }[]; }; rcs?: { template: string; type?: string; variables?: { name: string; props: object; type: string; id?: number; }[]; }; sms?: { template: string; type?: string; variables?: { name: string; props: object; type: string; id?: number; }[]; }; whatsapp?: { template: string; type?: string; variables?: { name: string; props: object; type: string; id?: number; }[]; }; }; authenticationConfig?: { addSecurityRecommendation?: boolean; codeExpirationMinutes?: number; }; buttons?: { props: { activeFor: number; countryCode: string; offerCode: string; phoneNumber: string; quickReplyType: string; text: string; url: string; urlType: string; autofillText?: string; otpType?: string; packageName?: string; signatureHash?: string; }; type: string; id?: number; }[]; definitionVersion?: string; footer?: { template: string; type?: string; variables?: { name: string; props: { mediaType: string; sample: string; url: string; variableType: string; alt?: string; regex?: string; shortUrl?: string; }; type: string; id?: number; }[]; }; header?: { template: string; type?: string; variables?: { name: string; props: { mediaType: string; sample: string; url: string; variableType: string; alt?: string; regex?: string; shortUrl?: string; }; type: string; id?: number; }[]; }; };',
      'language?: string;',
      'sandbox?: boolean;',
    ...
    markdown:
      "## create\n\n`client.templates.create(category?: string, creation_source?: string, definition?: { body: { multiChannel?: object; rcs?: object; sms?: object; whatsapp?: object; }; authenticationConfig?: { addSecurityRecommendation?: boolean; codeExpirationMinutes?: number; }; buttons?: { props: object; type: string; id?: number; }[]; definitionVersion?: string; footer?: { template: string; type?: string; variables?: object[]; }; header?: { template: string; type?: string; variables?: object[]; }; }, language?: string, sandbox?: boolean, submit_for_review?: boolean, Idempotency-Key?: string, x-profile-id?: string): { data?: object; error?: object; meta?: object; success?: boolean; }`\n\n**post** `/v3/templates`\n\nCreates a new message template with header, body, footer, and buttons. The template can be submitted for review immediately or saved as draft for later submission.\n\n### Parameters\n\n- `category?: string`\n  Template category: MARKETING, UTILITY, AUTHENTICATION (optional, auto-detected if not provided)\n\n- `creation_source?: string`\n  Source of template creation (default: from-api)\n\n- `definition?: { body: { multiChannel?: { template: string; type?: string; variables?: { name: string; props: object; type: string; id?: number; }[]; }; rcs?: { template: string; type?: string; variables?: { name: string; props: object; type: string; id?: number; }[]; }; sms?: { template: string; type?: string; variables?: { name: string; props: object; type: string; id?: number; }[]; }; whatsapp?: { template: string; type?: string; variables?: { name: string; props: object; type: string; id?: number; }[]; }; }; authenticationConfig?: { addSecurityRecommendation?: boolean; codeExpirationMinutes?: number; }; buttons?: { props: { activeFor: number; countryCode: string; offerCode: string; phoneNumber: string; quickReplyType: string; text: string; url: string; urlType: string; autofillText?: string; otpType?: string; packageName?: string; signatureHash?: string; }; type: string; id?: number; }[]; definitionVersion?: string; footer?: { template: string; type?: string; variables?: { name: string; props: { mediaType: string; sample: string; url: string; variableType: string; alt?: string; regex?: string; shortUrl?: string; }; type: string; id?: number; }[]; }; header?: { template: string; type?: string; variables?: { name: string; props: { mediaType: string; sample: string; url: string; variableType: string; alt?: string; regex?: string; shortUrl?: string; }; type: string; id?: number; }[]; }; }`\n  Complete definition of a message template including header, body, footer, and buttons\n  - `body: { multiChannel?: { template: string; type?: string; variables?: { name: string; props: { mediaType: string; sample: string; url: string; variableType: string; alt?: string; regex?: string; shortUrl?: string; }; type: string; id?: number; }[]; }; rcs?: { template: string; type?: string; variables?: { name: string; props: { mediaType: string; sample: string; url: string; variableType: string; alt?: string; regex?: string; shortUrl?: string; }; type: string; id?: number; }[]; }; sms?: { template: string; type?: string; variables?: { name: string; props: { mediaType: string; sample: string; url: string; variableType: string; alt?: string; regex?: string; shortUrl?: string; }; type: string; id?: number; }[]; }; whatsapp?: { template: string; type?: string; variables?: { name: string; props: { mediaType: string; sample: string; url: string; variableType: string; alt?: string; regex?: string; shortUrl?: string; }; type: string; id?: number; }[]; }; }`\n    Body section of a message template with channel-specific content\n  - `authenticationConfig?: { addSecurityRecommendation?: boolean; codeExpirationMinutes?: number; }`\n    Configuration for AUTHENTICATION category templates\n  - `buttons?: { props: { activeFor: number; countryCode: string; offerCode: string; phoneNumber: string; quickReplyType: string; text: string; url: string; urlType: string; autofillText?: string; otpType?: string; packageName?: string; signatureHash?: string; }; type: string; id?: number; }[]`\n    Optional list of interactive buttons (e.g., quick replies, URLs, phone numbers)\n  - `definitionVersion?: string`\n    The version of the template definition format\n  - `footer?: { template: string; type?: string; variables?: { name: string; props: { mediaType: string; sample: string; url: string; variableType: string; alt?: string; regex?: string; shortUrl?: string; }; type: string; id?: number; }[]; }`\n    Footer section of a message template\n  - `header?: { template: string; type?: string; variables?: { name: string; props: { mediaType: string; sample: string; url: string; variableType: string; alt?: string; regex?: string; shortUrl?: string; }; type: string; id?: number; }[]; }`\n    Header section of a message template\n\n- `language?: string`\n  Template language code (e.g., en_US) (optional, auto-detected if not provided)\n\n- `sandbox?: boolean`\n  Sandbox flag - when true, the operation is simulated without side effects\nUseful for testing integrations without actual execution\n\n- `submit_for_review?: boolean`\n  Whether to submit the template for review after creation (default: false)\n\n- `Idempotency-Key?: string`\n\n- `x-profile-id?: string`\n\n### Returns\n\n- `{ data?: { id?: string; category?: string; channels?: string[]; created_at?: string; is_published?: boolean; language?: string; name?: string; status?: string; updated_at?: string; variables?: string[]; }; error?: { code?: string; details?: object; doc_url?: string; message?: string; }; meta?: { request_id?: string; timestamp?: string; version?: string; }; success?: boolean; }`\n  Standard API response envelope for all v3 endpoints\n\n  - `data?: { id?: string; category?: string; channels?: string[]; created_at?: string; is_published?: boolean; language?: string; name?: string; status?: string; updated_at?: string; variables?: string[]; }`\n  - `error?: { code?: string; details?: object; doc_url?: string; message?: string; }`\n  - `meta?: { request_id?: string; timestamp?: string; version?: string; }`\n  - `success?: boolean`\n\n### Example\n\n```typescript\nimport Sent from '@sentdm/sentdm';\n\nconst client = new Sent();\n\nconst template = await client.templates.create();\n\nconsole.log(template);\n```",
    perLanguage: {
      typescript: {
      ...
      java: {
        method: 'templates().create',
        example:
          'package dm.sent.example;\n\nimport dm.sent.client.SentClient;\nimport dm.sent.client.okhttp.SentOkHttpClient;\nimport dm.sent.models.templates.TemplateCreateParams;\nimport dm.sent.models.templates.TemplateCreateResponse;\n\npublic final class Main {\n    private Main() {}\n\n    public static void main(String[] args) {\n        SentClient client = SentOkHttpClient.fromEnv();\n\n        TemplateCreateResponse template = client.templates().create();\n    }\n}',
      },
      go: {
        method: 'client.Templates.New',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/sentdm/sent-dm-go"\n\t"github.com/sentdm/sent-dm-go/option"\n)\n\nfunc main() {\n\tclient := sentdm.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\ttemplate, err := client.Templates.New(context.TODO(), sentdm.TemplateNewParams{})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", template.Data)\n}\n',
      },
      ruby: {
        method: 'templates.create',
        example:
          'require "sentdm"\n\nsent = Sentdm::Client.new(api_key: "My API Key")\n\ntemplate = sent.templates.create\n\nputs(template)',
      },
      php: {
        method: 'templates->create',
        example:
  ...
  },
  {
    ...
    response:
      '{ data?: { id?: string; category?: string; channels?: string[]; created_at?: string; is_published?: boolean; language?: string; name?: string; status?: string; updated_at?: string; variables?: string[]; }; error?: { code?: string; details?: object; doc_url?: string; message?: string; }; meta?: { request_id?: string; timestamp?: string; version?: string; }; success?: boolean; }',
    markdown:
      "## retrieve\n\n`client.templates.retrieve(id: string, x-profile-id?: string): { data?: object; error?: object; meta?: object; success?: boolean; }`\n\n**get** `/v3/templates/{id}`\n\nRetrieves a specific template by its ID. Returns template details including name, category, language, status, and definition.\n\n### Parameters\n\n- `id: string`\n\n- `x-profile-id?: string`\n\n### Returns\n\n- `{ data?: { id?: string; category?: string; channels?: string[]; created_at?: string; is_published?: boolean; language?: string; name?: string; status?: string; updated_at?: string; variables?: string[]; }; error?: { code?: string; details?: object; doc_url?: string; message?: string; }; meta?: { request_id?: string; timestamp?: string; version?: string; }; success?: boolean; }`\n  Standard API response envelope for all v3 endpoints\n\n  - `data?: { id?: string; category?: string; channels?: string[]; created_at?: string; is_published?: boolean; language?: string; name?: string; status?: string; updated_at?: string; variables?: string[]; }`\n  - `error?: { code?: string; details?: object; doc_url?: string; message?: string; }`\n  - `meta?: { request_id?: string; timestamp?: string; version?: string; }`\n  - `success?: boolean`\n\n### Example\n\n```typescript\nimport Sent from '@sentdm/sentdm';\n\nconst client = new Sent();\n\nconst template = await client.templates.retrieve('7ba7b820-9dad-11d1-80b4-00c04fd430c8');\n\nconsole.log(template);\n```",
    perLanguage: {
      typescript: {
      ...
      java: {
        method: 'templates().retrieve',
        example:
          'package dm.sent.example;\n\nimport dm.sent.client.SentClient;\nimport dm.sent.client.okhttp.SentOkHttpClient;\nimport dm.sent.models.templates.TemplateRetrieveParams;\nimport dm.sent.models.templates.TemplateRetrieveResponse;\n\npublic final class Main {\n    private Main() {}\n\n    public static void main(String[] args) {\n        SentClient client = SentOkHttpClient.fromEnv();\n\n        TemplateRetrieveResponse template = client.templates().retrieve("7ba7b820-9dad-11d1-80b4-00c04fd430c8");\n    }\n}',
      },
      go: {
        method: 'client.Templates.Get',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/sentdm/sent-dm-go"\n\t"github.com/sentdm/sent-dm-go/option"\n)\n\nfunc main() {\n\tclient := sentdm.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\ttemplate, err := client.Templates.Get(\n\t\tcontext.TODO(),\n\t\t"7ba7b820-9dad-11d1-80b4-00c04fd430c8",\n\t\tsentdm.TemplateGetParams{},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", template.Data)\n}\n',
      },
      ruby: {
        method: 'templates.retrieve',
        example:
          'require "sentdm"\n\nsent = Sentdm::Client.new(api_key: "My API Key")\n\ntemplate = sent.templates.retrieve("7ba7b820-9dad-11d1-80b4-00c04fd430c8")\n\nputs(template)',
      },
      php: {
        method: 'templates->retrieve',
        example:
  ...
  },
  {
    ...
    response:
      '{ data?: { id?: string; category?: string; channels?: string[]; created_at?: string; is_published?: boolean; language?: string; name?: string; status?: string; updated_at?: string; variables?: string[]; }; error?: { code?: string; details?: object; doc_url?: string; message?: string; }; meta?: { request_id?: string; timestamp?: string; version?: string; }; success?: boolean; }',
    markdown:
      "## update\n\n`client.templates.update(id: string, category?: string, definition?: { body: { multiChannel?: object; rcs?: object; sms?: object; whatsapp?: object; }; authenticationConfig?: { addSecurityRecommendation?: boolean; codeExpirationMinutes?: number; }; buttons?: { props: object; type: string; id?: number; }[]; definitionVersion?: string; footer?: { template: string; type?: string; variables?: object[]; }; header?: { template: string; type?: string; variables?: object[]; }; }, language?: string, name?: string, sandbox?: boolean, submit_for_review?: boolean, Idempotency-Key?: string, x-profile-id?: string): { data?: object; error?: object; meta?: object; success?: boolean; }`\n\n**put** `/v3/templates/{id}`\n\nUpdates an existing template's name, category, language, definition, or submits it for review.\n\n### Parameters\n\n- `id: string`\n\n- `category?: string`\n  Template category: MARKETING, UTILITY, AUTHENTICATION\n\n- `definition?: { body: { multiChannel?: { template: string; type?: string; variables?: { name: string; props: object; type: string; id?: number; }[]; }; rcs?: { template: string; type?: string; variables?: { name: string; props: object; type: string; id?: number; }[]; }; sms?: { template: string; type?: string; variables?: { name: string; props: object; type: string; id?: number; }[]; }; whatsapp?: { template: string; type?: string; variables?: { name: string; props: object; type: string; id?: number; }[]; }; }; authenticationConfig?: { addSecurityRecommendation?: boolean; codeExpirationMinutes?: number; }; buttons?: { props: { activeFor: number; countryCode: string; offerCode: string; phoneNumber: string; quickReplyType: string; text: string; url: string; urlType: string; autofillText?: string; otpType?: string; packageName?: string; signatureHash?: string; }; type: string; id?: number; }[]; definitionVersion?: string; footer?: { template: string; type?: string; variables?: { name: string; props: { mediaType: string; sample: string; url: string; variableType: string; alt?: string; regex?: string; shortUrl?: string; }; type: string; id?: number; }[]; }; header?: { template: string; type?: string; variables?: { name: string; props: { mediaType: string; sample: string; url: string; variableType: string; alt?: string; regex?: string; shortUrl?: string; }; type: string; id?: number; }[]; }; }`\n  Complete definition of a message template including header, body, footer, and buttons\n  - `body: { multiChannel?: { template: string; type?: string; variables?: { name: string; props: { mediaType: string; sample: string; url: string; variableType: string; alt?: string; regex?: string; shortUrl?: string; }; type: string; id?: number; }[]; }; rcs?: { template: string; type?: string; variables?: { name: string; props: { mediaType: string; sample: string; url: string; variableType: string; alt?: string; regex?: string; shortUrl?: string; }; type: string; id?: number; }[]; }; sms?: { template: string; type?: string; variables?: { name: string; props: { mediaType: string; sample: string; url: string; variableType: string; alt?: string; regex?: string; shortUrl?: string; }; type: string; id?: number; }[]; }; whatsapp?: { template: string; type?: string; variables?: { name: string; props: { mediaType: string; sample: string; url: string; variableType: string; alt?: string; regex?: string; shortUrl?: string; }; type: string; id?: number; }[]; }; }`\n    Body section of a message template with channel-specific content\n  - `authenticationConfig?: { addSecurityRecommendation?: boolean; codeExpirationMinutes?: number; }`\n    Configuration for AUTHENTICATION category templates\n  - `buttons?: { props: { activeFor: number; countryCode: string; offerCode: string; phoneNumber: string; quickReplyType: string; text: string; url: string; urlType: string; autofillText?: string; otpType?: string; packageName?: string; signatureHash?: string; }; type: string; id?: number; }[]`\n    Optional list of interactive buttons (e.g., quick replies, URLs, phone numbers)\n  - `definitionVersion?: string`\n    The version of the template definition format\n  - `footer?: { template: string; type?: string; variables?: { name: string; props: { mediaType: string; sample: string; url: string; variableType: string; alt?: string; regex?: string; shortUrl?: string; }; type: string; id?: number; }[]; }`\n    Footer section of a message template\n  - `header?: { template: string; type?: string; variables?: { name: string; props: { mediaType: string; sample: string; url: string; variableType: string; alt?: string; regex?: string; shortUrl?: string; }; type: string; id?: number; }[]; }`\n    Header section of a message template\n\n- `language?: string`\n  Template language code (e.g., en_US)\n\n- `name?: string`\n  Template display name\n\n- `sandbox?: boolean`\n  Sandbox flag - when true, the operation is simulated without side effects\nUseful for testing integrations without actual execution\n\n- `submit_for_review?: boolean`\n  Whether to submit the template for review after updating (default: false)\n\n- `Idempotency-Key?: string`\n\n- `x-profile-id?: string`\n\n### Returns\n\n- `{ data?: { id?: string; category?: string; channels?: string[]; created_at?: string; is_published?: boolean; language?: string; name?: string; status?: string; updated_at?: string; variables?: string[]; }; error?: { code?: string; details?: object; doc_url?: string; message?: string; }; meta?: { request_id?: string; timestamp?: string; version?: string; }; success?: boolean; }`\n  Standard API response envelope for all v3 endpoints\n\n  - `data?: { id?: string; category?: string; channels?: string[]; created_at?: string; is_published?: boolean; language?: string; name?: string; status?: string; updated_at?: string; variables?: string[]; }`\n  - `error?: { code?: string; details?: object; doc_url?: string; message?: string; }`\n  - `meta?: { request_id?: string; timestamp?: string; version?: string; }`\n  - `success?: boolean`\n\n### Example\n\n```typescript\nimport Sent from '@sentdm/sentdm';\n\nconst client = new Sent();\n\nconst template = await client.templates.update('7ba7b820-9dad-11d1-80b4-00c04fd430c8');\n\nconsole.log(template);\n```",
    perLanguage: {
      typescript: {
      ...
      ruby: {
        method: 'templates.update',
        example:
          'require "sentdm"\n\nsent = Sentdm::Client.new(api_key: "My API Key")\n\ntemplate = sent.templates.update("7ba7b820-9dad-11d1-80b4-00c04fd430c8")\n\nputs(template)',
      },
      php: {
        method: 'templates->update',
        example:
      ...
      csharp: {
        method: 'Templates.Update',
        example:
          'TemplateUpdateParams parameters = new()\n{\n    ID = "7ba7b820-9dad-11d1-80b4-00c04fd430c8"\n};\n\nvar template = await client.Templates.Update(parameters);\n\nConsole.WriteLine(template);',
      },
      http: {
        example:
          'curl https://api.sent.dm/v3/templates/$ID \\\n    -X PUT \\\n    -H \'Content-Type: application/json\' \\\n    -H "x-api-key: $SENT_DM_API_KEY" \\\n    -d \'{\n          "category": "MARKETING",\n          "definition": {\n            "body": {}\n          },\n          "language": null,\n          "name": "Updated Welcome Message",\n          "sandbox": false,\n          "submit_for_review": false\n        }\'',
  ...
  },
  {
    ...
    params: [
      ...
      "brand?: { compliance: { brandRelationship: 'BASIC_ACCOUNT' | 'MEDIUM_ACCOUNT' | 'LARGE_ACCOUNT' | 'SMALL_ACCOUNT' | 'KEY_ACCOUNT'; vertical: string; destinationCountries?: { id?: string; isMain?: boolean; }[]; expectedMessagingVolume?: string; isTcrApplication?: boolean; notes?: string; phoneNumberPrefix?: string; primaryUseCase?: string; }; contact: { name: string; businessName?: string; email?: string; phone?: string; phoneCountryCode?: string; role?: string; }; business?: { city?: string; country?: string; countryOfRegistration?: string; entityType?: 'PRIVATE_PROFIT' | 'PUBLIC_PROFIT' | 'NON_PROFIT' | 'SOLE_PROPRIETOR' | 'GOVERNMENT'; legalName?: string; postalCode?: string; state?: string; street?: string; taxId?: string; taxIdType?: string; url?: string; }; };",
      'description?: string;',
      'icon?: string;',
    ...
    perLanguage: {
      ...
      java: {
        method: 'profiles().create',
        example:
          'package dm.sent.example;\n\nimport dm.sent.client.SentClient;\nimport dm.sent.client.okhttp.SentOkHttpClient;\nimport dm.sent.models.profiles.ProfileCreateParams;\nimport dm.sent.models.profiles.ProfileCreateResponse;\n\npublic final class Main {\n    private Main() {}\n\n    public static void main(String[] args) {\n        SentClient client = SentOkHttpClient.fromEnv();\n\n        ProfileCreateResponse profile = client.profiles().create();\n    }\n}',
      },
      go: {
        method: 'client.Profiles.New',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/sentdm/sent-dm-go"\n\t"github.com/sentdm/sent-dm-go/option"\n)\n\nfunc main() {\n\tclient := sentdm.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tprofile, err := client.Profiles.New(context.TODO(), sentdm.ProfileNewParams{})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", profile.Data)\n}\n',
      },
      ruby: {
        method: 'profiles.create',
        example:
          'require "sentdm"\n\nsent = Sentdm::Client.new(api_key: "My API Key")\n\nprofile = sent.profiles.create\n\nputs(profile)',
      },
      php: {
        method: 'profiles->create',
        example:
  ...
  },
  {
    ...
    params: ['x-profile-id?: string;'],
    response:
      '{ data?: { profiles?: { id?: string; allow_contact_sharing?: boolean; allow_number_change_during_onboarding?: boolean; allow_template_sharing?: boolean; billing_contact?: object; billing_model?: string; brand?: object; created_at?: string; description?: string; email?: string; icon?: string; inherit_contacts?: boolean; inherit_tcr_brand?: boolean; inherit_tcr_campaign?: boolean; inherit_templates?: boolean; name?: string; organization_id?: string; sending_phone_number?: string; sending_phone_number_profile_id?: string; sending_whatsapp_number_profile_id?: string; short_name?: string; status?: string; updated_at?: string; waba_id?: string; whatsapp_phone_number?: string; }[]; }; error?: { code?: string; details?: object; doc_url?: string; message?: string; }; meta?: { request_id?: string; timestamp?: string; version?: string; }; success?: boolean; }',
    markdown:
      "## list\n\n`client.profiles.list(x-profile-id?: string): { data?: object; error?: object; meta?: object; success?: boolean; }`\n\n**get** `/v3/profiles`\n\nRetrieves all sender profiles within an organization, including brand information for each profile. Profiles represent different brands, departments, or use cases within an organization, each with their own messaging configuration.\n\n### Parameters\n\n- `x-profile-id?: string`\n\n### Returns\n\n- `{ data?: { profiles?: { id?: string; allow_contact_sharing?: boolean; allow_number_change_during_onboarding?: boolean; allow_template_sharing?: boolean; billing_contact?: object; billing_model?: string; brand?: object; created_at?: string; description?: string; email?: string; icon?: string; inherit_contacts?: boolean; inherit_tcr_brand?: boolean; inherit_tcr_campaign?: boolean; inherit_templates?: boolean; name?: string; organization_id?: string; sending_phone_number?: string; sending_phone_number_profile_id?: string; sending_whatsapp_number_profile_id?: string; short_name?: string; status?: string; updated_at?: string; waba_id?: string; whatsapp_phone_number?: string; }[]; }; error?: { code?: string; details?: object; doc_url?: string; message?: string; }; meta?: { request_id?: string; timestamp?: string; version?: string; }; success?: boolean; }`\n  Standard API response envelope for all v3 endpoints\n\n  - `data?: { profiles?: { id?: string; allow_contact_sharing?: boolean; allow_number_change_during_onboarding?: boolean; allow_template_sharing?: boolean; billing_contact?: { address?: string; email?: string; name?: string; phone?: string; }; billing_model?: string; brand?: { id?: string; business?: { city?: string; country?: string; country_of_registration?: string; entity_type?: string; legal_name?: string; postal_code?: string; state?: string; street?: string; tax_id?: string; tax_id_type?: string; url?: string; }; compliance?: { brand_relationship?: 'BASIC_ACCOUNT' | 'MEDIUM_ACCOUNT' | 'LARGE_ACCOUNT' | 'SMALL_ACCOUNT' | 'KEY_ACCOUNT'; destination_countries?: object[]; expected_messaging_volume?: string; is_tcr_application?: boolean; notes?: string; phone_number_prefix?: string; primary_use_case?: string; vertical?: string; }; contact?: { business_name?: string; email?: string; name?: string; phone?: string; phone_country_code?: string; role?: string; }; created_at?: string; csp_id?: string; identity_status?: 'SELF_DECLARED' | 'UNVERIFIED' | 'VERIFIED' | 'VETTED_VERIFIED'; is_inherited?: boolean; status?: 'ACTIVE' | 'INACTIVE' | 'SUSPENDED'; submitted_at?: string; submitted_to_tcr?: boolean; tcr_brand_id?: string; universal_ein?: string; updated_at?: string; }; created_at?: string; description?: string; email?: string; icon?: string; inherit_contacts?: boolean; inherit_tcr_brand?: boolean; inherit_tcr_campaign?: boolean; inherit_templates?: boolean; name?: string; organization_id?: string; sending_phone_number?: string; sending_phone_number_profile_id?: string; sending_whatsapp_number_profile_id?: string; short_name?: string; status?: string; updated_at?: string; waba_id?: string; whatsapp_phone_number?: string; }[]; }`\n  - `error?: { code?: string; details?: object; doc_url?: string; message?: string; }`\n  - `meta?: { request_id?: string; timestamp?: string; version?: string; }`\n  - `success?: boolean`\n\n### Example\n\n```typescript\nimport Sent from '@sentdm/sentdm';\n\nconst client = new Sent();\n\nconst profiles = await client.profiles.list();\n\nconsole.log(profiles);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      '{ data?: { id?: string; allow_contact_sharing?: boolean; allow_number_change_during_onboarding?: boolean; allow_template_sharing?: boolean; billing_contact?: object; billing_model?: string; brand?: object; created_at?: string; description?: string; email?: string; icon?: string; inherit_contacts?: boolean; inherit_tcr_brand?: boolean; inherit_tcr_campaign?: boolean; inherit_templates?: boolean; name?: string; organization_id?: string; sending_phone_number?: string; sending_phone_number_profile_id?: string; sending_whatsapp_number_profile_id?: string; short_name?: string; status?: string; updated_at?: string; waba_id?: string; whatsapp_phone_number?: string; }; error?: { code?: string; details?: object; doc_url?: string; message?: string; }; meta?: { request_id?: string; timestamp?: string; version?: string; }; success?: boolean; }',
    markdown:
      "## retrieve\n\n`client.profiles.retrieve(profileId: string, x-profile-id?: string): { data?: object; error?: object; meta?: object; success?: boolean; }`\n\n**get** `/v3/profiles/{profileId}`\n\nRetrieves detailed information about a specific sender profile within an organization, including brand and KYC information if a brand has been configured.\n\n### Parameters\n\n- `profileId: string`\n\n- `x-profile-id?: string`\n\n### Returns\n\n- `{ data?: { id?: string; allow_contact_sharing?: boolean; allow_number_change_during_onboarding?: boolean; allow_template_sharing?: boolean; billing_contact?: { address?: string; email?: string; name?: string; phone?: string; }; billing_model?: string; brand?: { id?: string; business?: object; compliance?: object; contact?: object; created_at?: string; csp_id?: string; identity_status?: 'SELF_DECLARED' | 'UNVERIFIED' | 'VERIFIED' | 'VETTED_VERIFIED'; is_inherited?: boolean; status?: 'ACTIVE' | 'INACTIVE' | 'SUSPENDED'; submitted_at?: string; submitted_to_tcr?: boolean; tcr_brand_id?: string; universal_ein?: string; updated_at?: string; }; created_at?: string; description?: string; email?: string; icon?: string; inherit_contacts?: boolean; inherit_tcr_brand?: boolean; inherit_tcr_campaign?: boolean; inherit_templates?: boolean; name?: string; organization_id?: string; sending_phone_number?: string; sending_phone_number_profile_id?: string; sending_whatsapp_number_profile_id?: string; short_name?: string; status?: string; updated_at?: string; waba_id?: string; whatsapp_phone_number?: string; }; error?: { code?: string; details?: object; doc_url?: string; message?: string; }; meta?: { request_id?: string; timestamp?: string; version?: string; }; success?: boolean; }`\n  Standard API response envelope for all v3 endpoints\n\n  - `data?: { id?: string; allow_contact_sharing?: boolean; allow_number_change_during_onboarding?: boolean; allow_template_sharing?: boolean; billing_contact?: { address?: string; email?: string; name?: string; phone?: string; }; billing_model?: string; brand?: { id?: string; business?: { city?: string; country?: string; country_of_registration?: string; entity_type?: string; legal_name?: string; postal_code?: string; state?: string; street?: string; tax_id?: string; tax_id_type?: string; url?: string; }; compliance?: { brand_relationship?: 'BASIC_ACCOUNT' | 'MEDIUM_ACCOUNT' | 'LARGE_ACCOUNT' | 'SMALL_ACCOUNT' | 'KEY_ACCOUNT'; destination_countries?: { id?: string; isMain?: boolean; }[]; expected_messaging_volume?: string; is_tcr_application?: boolean; notes?: string; phone_number_prefix?: string; primary_use_case?: string; vertical?: string; }; contact?: { business_name?: string; email?: string; name?: string; phone?: string; phone_country_code?: string; role?: string; }; created_at?: string; csp_id?: string; identity_status?: 'SELF_DECLARED' | 'UNVERIFIED' | 'VERIFIED' | 'VETTED_VERIFIED'; is_inherited?: boolean; status?: 'ACTIVE' | 'INACTIVE' | 'SUSPENDED'; submitted_at?: string; submitted_to_tcr?: boolean; tcr_brand_id?: string; universal_ein?: string; updated_at?: string; }; created_at?: string; description?: string; email?: string; icon?: string; inherit_contacts?: boolean; inherit_tcr_brand?: boolean; inherit_tcr_campaign?: boolean; inherit_templates?: boolean; name?: string; organization_id?: string; sending_phone_number?: string; sending_phone_number_profile_id?: string; sending_whatsapp_number_profile_id?: string; short_name?: string; status?: string; updated_at?: string; waba_id?: string; whatsapp_phone_number?: string; }`\n  - `error?: { code?: string; details?: object; doc_url?: string; message?: string; }`\n  - `meta?: { request_id?: string; timestamp?: string; version?: string; }`\n  - `success?: boolean`\n\n### Example\n\n```typescript\nimport Sent from '@sentdm/sentdm';\n\nconst client = new Sent();\n\nconst profile = await client.profiles.retrieve('profileId');\n\nconsole.log(profile);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'profiles.update',
        example:
          'require "sentdm"\n\nsent = Sentdm::Client.new(api_key: "My API Key")\n\nprofile = sent.profiles.update("profileId")\n\nputs(profile)',
      },
      php: {
        method: 'profiles->update',
        example:
  ...
  },
  {
    ...
    params: [
      'profileId: string;',
      'campaign: { description: string; name: string; type: string; useCases: { messagingUseCaseUs: string; sampleMessages: string[]; }[]; helpKeywords?: string; helpMessage?: string; messageFlow?: string; optinKeywords?: string; optinMessage?: string; optoutKeywords?: string; optoutMessage?: string; privacyPolicyLink?: string; termsAndConditionsLink?: string; };',
      'sandbox?: boolean;',
      'Idempotency-Key?: string;',
      'x-profile-id?: string;',
    ],
    response:
      "{ data?: { id?: string; billedDate?: string; brandId?: string; cost?: number; createdAt?: string; cspId?: string; customerId?: string; dcaElectionsComplete?: boolean; dcaElectionsCompletedAt?: string; description?: string; helpKeywords?: string; helpMessage?: string; kycSubmissionFormId?: string; messageFlow?: string; name?: string; optinKeywords?: string; optinMessage?: string; optoutKeywords?: string; optoutMessage?: string; privacyPolicyLink?: string; resellerId?: string; sharingStatus?: 'PENDING' | 'ACCEPTED' | 'DECLINED'; status?: 'SENT_CREATED' | 'ACTIVE' | 'EXPIRED'; submittedAt?: string; submittedToTCR?: boolean; tcrCampaignId?: string; tcrSyncError?: string; telnyxCampaignId?: string; termsAndConditionsLink?: string; type?: string; updatedAt?: string; upstreamCnpId?: string; useCases?: { id?: string; campaignId?: string; createdAt?: string; customerId?: string; messagingUseCaseUs?: string; sampleMessages?: string[]; updatedAt?: string; }[]; }; error?: { code?: string; details?: object; doc_url?: string; message?: string; }; meta?: { request_id?: string; timestamp?: string; version?: string; }; success?: boolean; }",
    markdown:
      "## create\n\n`client.profiles.campaigns.create(profileId: string, campaign: { description: string; name: string; type: string; useCases: { messagingUseCaseUs: string; sampleMessages: string[]; }[]; helpKeywords?: string; helpMessage?: string; messageFlow?: string; optinKeywords?: string; optinMessage?: string; optoutKeywords?: string; optoutMessage?: string; privacyPolicyLink?: string; termsAndConditionsLink?: string; }, sandbox?: boolean, Idempotency-Key?: string, x-profile-id?: string): { data?: object; error?: object; meta?: object; success?: boolean; }`\n\n**post** `/v3/profiles/{profileId}/campaigns`\n\nCreates a new campaign scoped under the brand of the specified profile. Each campaign must include at least one use case with sample messages.\n\n### Parameters\n\n- `profileId: string`\n\n- `campaign: { description: string; name: string; type: string; useCases: { messagingUseCaseUs: string; sampleMessages: string[]; }[]; helpKeywords?: string; helpMessage?: string; messageFlow?: string; optinKeywords?: string; optinMessage?: string; optoutKeywords?: string; optoutMessage?: string; privacyPolicyLink?: string; termsAndConditionsLink?: string; }`\n  Campaign data for create or update operation\n  - `description: string`\n    Campaign description\n  - `name: string`\n    Campaign name\n  - `type: string`\n    Campaign type (e.g., \"KYC\", \"App\")\n  - `useCases: { messagingUseCaseUs: string; sampleMessages: string[]; }[]`\n    List of use cases with sample messages\n  - `helpKeywords?: string`\n    Comma-separated keywords that trigger help message (e.g., \"HELP, INFO, SUPPORT\")\n  - `helpMessage?: string`\n    Message sent when user requests help\n  - `messageFlow?: string`\n    Description of how messages flow in the campaign\n  - `optinKeywords?: string`\n    Comma-separated keywords that trigger opt-in (e.g., \"YES, START, SUBSCRIBE\")\n  - `optinMessage?: string`\n    Message sent when user opts in\n  - `optoutKeywords?: string`\n    Comma-separated keywords that trigger opt-out (e.g., \"STOP, UNSUBSCRIBE, END\")\n  - `optoutMessage?: string`\n    Message sent when user opts out\n  - `privacyPolicyLink?: string`\n    URL to privacy policy\n  - `termsAndConditionsLink?: string`\n    URL to terms and conditions\n\n- `sandbox?: boolean`\n  Sandbox flag - when true, the operation is simulated without side effects\nUseful for testing integrations without actual execution\n\n- `Idempotency-Key?: string`\n\n- `x-profile-id?: string`\n\n### Returns\n\n- `{ data?: { id?: string; billedDate?: string; brandId?: string; cost?: number; createdAt?: string; cspId?: string; customerId?: string; dcaElectionsComplete?: boolean; dcaElectionsCompletedAt?: string; description?: string; helpKeywords?: string; helpMessage?: string; kycSubmissionFormId?: string; messageFlow?: string; name?: string; optinKeywords?: string; optinMessage?: string; optoutKeywords?: string; optoutMessage?: string; privacyPolicyLink?: string; resellerId?: string; sharingStatus?: 'PENDING' | 'ACCEPTED' | 'DECLINED'; status?: 'SENT_CREATED' | 'ACTIVE' | 'EXPIRED'; submittedAt?: string; submittedToTCR?: boolean; tcrCampaignId?: string; tcrSyncError?: string; telnyxCampaignId?: string; termsAndConditionsLink?: string; type?: string; updatedAt?: string; upstreamCnpId?: string; useCases?: { id?: string; campaignId?: string; createdAt?: string; customerId?: string; messagingUseCaseUs?: string; sampleMessages?: string[]; updatedAt?: string; }[]; }; error?: { code?: string; details?: object; doc_url?: string; message?: string; }; meta?: { request_id?: string; timestamp?: string; version?: string; }; success?: boolean; }`\n  Standard API response envelope for all v3 endpoints\n\n  - `data?: { id?: string; billedDate?: string; brandId?: string; cost?: number; createdAt?: string; cspId?: string; customerId?: string; dcaElectionsComplete?: boolean; dcaElectionsCompletedAt?: string; description?: string; helpKeywords?: string; helpMessage?: string; kycSubmissionFormId?: string; messageFlow?: string; name?: string; optinKeywords?: string; optinMessage?: string; optoutKeywords?: string; optoutMessage?: string; privacyPolicyLink?: string; resellerId?: string; sharingStatus?: 'PENDING' | 'ACCEPTED' | 'DECLINED'; status?: 'SENT_CREATED' | 'ACTIVE' | 'EXPIRED'; submittedAt?: string; submittedToTCR?: boolean; tcrCampaignId?: string; tcrSyncError?: string; telnyxCampaignId?: string; termsAndConditionsLink?: string; type?: string; updatedAt?: string; upstreamCnpId?: string; useCases?: { id?: string; campaignId?: string; createdAt?: string; customerId?: string; messagingUseCaseUs?: string; sampleMessages?: string[]; updatedAt?: string; }[]; }`\n  - `error?: { code?: string; details?: object; doc_url?: string; message?: string; }`\n  - `meta?: { request_id?: string; timestamp?: string; version?: string; }`\n  - `success?: boolean`\n\n### Example\n\n```typescript\nimport Sent from '@sentdm/sentdm';\n\nconst client = new Sent();\n\nconst campaign = await client.profiles.campaigns.create('770e8400-e29b-41d4-a716-446655440002', { campaign: {\n  description: 'Appointment reminders and account notifications',\n  name: 'Customer Notifications',\n  type: 'App',\n  useCases: [{ messagingUseCaseUs: 'ACCOUNT_NOTIFICATION', sampleMessages: ['Hi {name}, your appointment is confirmed for {date} at {time}.', 'Your order #{order_id} has been shipped. Track at {url}'] }],\n} });\n\nconsole.log(campaign);\n```",
    perLanguage: {
      typescript: {
        method: 'client.profiles.campaigns.create',
        example:
          "import Sent from '@sentdm/sentdm';\n\nconst client = new Sent({\n  apiKey: process.env['SENT_DM_API_KEY'], // This is the default and can be omitted\n});\n\nconst campaign = await client.profiles.campaigns.create('770e8400-e29b-41d4-a716-446655440002', {\n  campaign: {\n    description: 'Appointment reminders and account notifications',\n    name: 'Customer Notifications',\n    type: 'App',\n    useCases: [\n      {\n        messagingUseCaseUs: 'ACCOUNT_NOTIFICATION',\n        sampleMessages: [\n          'Hi {name}, your appointment is confirmed for {date} at {time}.',\n          'Your order #{order_id} has been shipped. Track at {url}',\n        ],\n      },\n    ],\n  },\n});\n\nconsole.log(campaign.data);",
      },
      python: {
  ...
  },
  {
    ...
    perLanguage: {
      ...
      java: {
        method: 'profiles().campaigns().update',
        example:
          'package dm.sent.example;\n\nimport dm.sent.client.SentClient;\nimport dm.sent.client.okhttp.SentOkHttpClient;\nimport dm.sent.models.profiles.campaigns.CampaignUpdateParams;\nimport dm.sent.models.profiles.campaigns.CampaignUpdateResponse;\n\npublic final class Main {\n    private Main() {}\n\n    public static void main(String[] args) {\n        SentClient client = SentOkHttpClient.fromEnv();\n\n        CampaignUpdateParams params = CampaignUpdateParams.builder()\n            .profileId("770e8400-e29b-41d4-a716-446655440002")\n            .campaignId("b2c3d4e5-f6a7-8901-bcde-f12345678901")\n            .campaign(CampaignUpdateParams.Campaign.builder()\n                .description("Updated appointment reminders and account notifications")\n                .name("Customer Notifications Updated")\n                .type("App")\n                .addUseCase(CampaignUpdateParams.Campaign.UseCase.builder()\n                    .messagingUseCaseUs(CampaignUpdateParams.Campaign.UseCase.MessagingUseCaseUs.ACCOUNT_NOTIFICATION)\n                    .addSampleMessage("Hi {name}, your appointment is confirmed for {date} at {time}.")\n                    .addSampleMessage("Your order #{order_id} has been shipped. Track at {url}")\n                    .build())\n                .build())\n            .build();\n        CampaignUpdateResponse campaign = client.profiles().campaigns().update(params);\n    }\n}',
      },
      go: {
        method: 'client.Profiles.Campaigns.Update',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/sentdm/sent-dm-go"\n\t"github.com/sentdm/sent-dm-go/option"\n)\n\nfunc main() {\n\tclient := sentdm.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tcampaign, err := client.Profiles.Campaigns.Update(\n\t\tcontext.TODO(),\n\t\t"b2c3d4e5-f6a7-8901-bcde-f12345678901",\n\t\tsentdm.ProfileCampaignUpdateParams{\n\t\t\tProfileID: "770e8400-e29b-41d4-a716-446655440002",\n\t\t\tCampaign: sentdm.ProfileCampaignUpdateParamsCampaign{\n\t\t\t\tDescription: "Updated appointment reminders and account notifications",\n\t\t\t\tName:        "Customer Notifications Updated",\n\t\t\t\tType:        "App",\n\t\t\t\tUseCases: []sentdm.ProfileCampaignUpdateParamsCampaignUseCase{{\n\t\t\t\t\tMessagingUseCaseUs: "ACCOUNT_NOTIFICATION",\n\t\t\t\t\tSampleMessages:     []string{"Hi {name}, your appointment is confirmed for {date} at {time}.", "Your order #{order_id} has been shipped. Track at {url}"},\n\t\t\t\t}},\n\t\t\t},\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", campaign.Data)\n}\n',
      },
      ruby: {
        method: 'profiles.campaigns.update',
        example:
          'require "sentdm"\n\nsent = Sentdm::Client.new(api_key: "My API Key")\n\ncampaign = sent.profiles.campaigns.update(\n  "b2c3d4e5-f6a7-8901-bcde-f12345678901",\n  profile_id: "770e8400-e29b-41d4-a716-446655440002",\n  campaign: {\n    description: "Updated appointment reminders and account notifications",\n    name: "Customer Notifications Updated",\n    type: "App",\n    useCases: [\n      {\n        messagingUseCaseUs: :ACCOUNT_NOTIFICATION,\n        sampleMessages: [\n          "Hi {name}, your appointment is confirmed for {date} at {time}.",\n          "Your order \\#{order_id} has been shipped. Track at {url}"\n        ]\n      }\n    ]\n  }\n)\n\nputs(campaign)',
      },
      php: {
        method: 'profiles->campaigns->update',
        example:
      ...
      csharp: {
        method: 'Profiles.Campaigns.Update',
        example:
          'CampaignUpdateParams parameters = new()\n{\n    ProfileID = "770e8400-e29b-41d4-a716-446655440002",\n    CampaignID = "b2c3d4e5-f6a7-8901-bcde-f12345678901",\n    Campaign = new()\n    {\n        Description = "Updated appointment reminders and account notifications",\n        Name = "Customer Notifications Updated",\n        Type = "App",\n        UseCases =\n        [\n            new()\n            {\n                MessagingUseCaseUs = MessagingUseCaseUs.AccountNotification,\n                SampleMessages =\n                [\n                    "Hi {name}, your appointment is confirmed for {date} at {time}.",\n                    "Your order #{order_id} has been shipped. Track at {url}",\n                ],\n            },\n        ],\n        HelpKeywords = null,\n        HelpMessage = null,\n        MessageFlow = "User signs up on website and opts in to receive SMS notifications",\n        OptinKeywords = null,\n        OptinMessage = null,\n        OptoutKeywords = null,\n        OptoutMessage = null,\n        PrivacyPolicyLink = null,\n        TermsAndConditionsLink = null,\n    },\n};\n\nvar campaign = await client.Profiles.Campaigns.Update(parameters);\n\nConsole.WriteLine(campaign);',
      },
      http: {
        example:
          'curl https://api.sent.dm/v3/profiles/$PROFILE_ID/campaigns/$CAMPAIGN_ID \\\n    -X PUT \\\n    -H \'Content-Type: application/json\' \\\n    -H "x-api-key: $SENT_DM_API_KEY" \\\n    -d \'{\n          "campaign": {\n            "description": "Updated appointment reminders and account notifications",\n            "name": "Customer Notifications Updated",\n            "type": "App",\n            "useCases": [\n              {\n                "messagingUseCaseUs": "ACCOUNT_NOTIFICATION",\n                "sampleMessages": [\n                  "Hi {name}, your appointment is confirmed for {date} at {time}.",\n                  "Your order #{order_id} has been shipped. Track at {url}"\n                ]\n              }\n            ],\n            "helpKeywords": null,\n            "helpMessage": null,\n            "messageFlow": "User signs up on website and opts in to receive SMS notifications",\n            "optinKeywords": null,\n            "optinMessage": null,\n            "optoutKeywords": null,\n            "optoutMessage": null,\n            "privacyPolicyLink": null,\n            "termsAndConditionsLink": null\n          },\n          "sandbox": false\n        }\'',
  ...
  },
  {
    ...
    markdown:
      "## retrieve_status\n\n`client.messages.retrieveStatus(id: string, x-profile-id?: string): { data?: object; error?: object; meta?: object; success?: boolean; }`\n\n**get** `/v3/messages/{id}`\n\nRetrieves the current status and details of a message by ID. Includes delivery status, timestamps, and error information if applicable.\n\n### Parameters\n\n- `id: string`\n\n- `x-profile-id?: string`\n\n### Returns\n\n- `{ data?: { id?: string; active_contact_price?: number; channel?: string; contact_id?: string; created_at?: string; customer_id?: string; direction?: string; events?: { description?: string; status?: string; timestamp?: string; }[]; message_body?: { buttons?: object[]; content?: string; footer?: string; header?: string; }; phone?: string; phone_international?: string; price?: number; region_code?: string; status?: string; template_category?: string; template_id?: string; template_name?: string; }; error?: { code?: string; details?: object; doc_url?: string; message?: string; }; meta?: { request_id?: string; timestamp?: string; version?: string; }; success?: boolean; }`\n  Standard API response envelope for all v3 endpoints\n\n  - `data?: { id?: string; active_contact_price?: number; channel?: string; contact_id?: string; created_at?: string; customer_id?: string; direction?: string; events?: { description?: string; status?: string; timestamp?: string; }[]; message_body?: { buttons?: { postbackData?: string; text?: string; type?: string; value?: string; }[]; content?: string; footer?: string; header?: string; }; phone?: string; phone_international?: string; price?: number; region_code?: string; status?: string; template_category?: string; template_id?: string; template_name?: string; }`\n  - `error?: { code?: string; details?: object; doc_url?: string; message?: string; }`\n  - `meta?: { request_id?: string; timestamp?: string; version?: string; }`\n  - `success?: boolean`\n\n### Example\n\n```typescript\nimport Sent from '@sentdm/sentdm';\n\nconst client = new Sent();\n\nconst response = await client.messages.retrieveStatus('8ba7b830-9dad-11d1-80b4-00c04fd430c8');\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    perLanguage: {
      ...
      java: {
        method: 'contacts().create',
        example:
          'package dm.sent.example;\n\nimport dm.sent.client.SentClient;\nimport dm.sent.client.okhttp.SentOkHttpClient;\nimport dm.sent.models.contacts.ContactCreateParams;\nimport dm.sent.models.contacts.ContactCreateResponse;\n\npublic final class Main {\n    private Main() {}\n\n    public static void main(String[] args) {\n        SentClient client = SentOkHttpClient.fromEnv();\n\n        ContactCreateResponse contact = client.contacts().create();\n    }\n}',
      },
      go: {
        method: 'client.Contacts.New',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/sentdm/sent-dm-go"\n\t"github.com/sentdm/sent-dm-go/option"\n)\n\nfunc main() {\n\tclient := sentdm.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tcontact, err := client.Contacts.New(context.TODO(), sentdm.ContactNewParams{})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", contact.Data)\n}\n',
      },
      ruby: {
        method: 'contacts.create',
        example:
          'require "sentdm"\n\nsent = Sentdm::Client.new(api_key: "My API Key")\n\ncontact = sent.contacts.create\n\nputs(contact)',
      },
      php: {
        method: 'contacts->create',
        example:
  ...
  },
  {
    ...
    response:
      '{ data?: { id?: string; available_channels?: string; country_code?: string; created_at?: string; default_channel?: string; format_e164?: string; format_international?: string; format_national?: string; format_rfc?: string; is_inherited?: boolean; opt_out?: boolean; phone_number?: string; region_code?: string; updated_at?: string; }; error?: { code?: string; details?: object; doc_url?: string; message?: string; }; meta?: { request_id?: string; timestamp?: string; version?: string; }; success?: boolean; }',
    markdown:
      "## retrieve\n\n`client.contacts.retrieve(id: string, x-profile-id?: string): { data?: object; error?: object; meta?: object; success?: boolean; }`\n\n**get** `/v3/contacts/{id}`\n\nRetrieves a specific contact by their unique identifier. Returns detailed contact information including phone formats, available channels, and opt-out status.\n\n### Parameters\n\n- `id: string`\n\n- `x-profile-id?: string`\n\n### Returns\n\n- `{ data?: { id?: string; available_channels?: string; country_code?: string; created_at?: string; default_channel?: string; format_e164?: string; format_international?: string; format_national?: string; format_rfc?: string; is_inherited?: boolean; opt_out?: boolean; phone_number?: string; region_code?: string; updated_at?: string; }; error?: { code?: string; details?: object; doc_url?: string; message?: string; }; meta?: { request_id?: string; timestamp?: string; version?: string; }; success?: boolean; }`\n  Standard API response envelope for all v3 endpoints\n\n  - `data?: { id?: string; available_channels?: string; country_code?: string; created_at?: string; default_channel?: string; format_e164?: string; format_international?: string; format_national?: string; format_rfc?: string; is_inherited?: boolean; opt_out?: boolean; phone_number?: string; region_code?: string; updated_at?: string; }`\n  - `error?: { code?: string; details?: object; doc_url?: string; message?: string; }`\n  - `meta?: { request_id?: string; timestamp?: string; version?: string; }`\n  - `success?: boolean`\n\n### Example\n\n```typescript\nimport Sent from '@sentdm/sentdm';\n\nconst client = new Sent();\n\nconst contact = await client.contacts.retrieve('6ba7b810-9dad-11d1-80b4-00c04fd430c8');\n\nconsole.log(contact);\n```",
    perLanguage: {
      typescript: {
      ...
      ruby: {
        method: 'contacts.retrieve',
        example:
          'require "sentdm"\n\nsent = Sentdm::Client.new(api_key: "My API Key")\n\ncontact = sent.contacts.retrieve("6ba7b810-9dad-11d1-80b4-00c04fd430c8")\n\nputs(contact)',
      },
      php: {
        method: 'contacts->retrieve',
        example:
  ...
  },
  {
    ...
    response:
      '{ data?: { id?: string; available_channels?: string; country_code?: string; created_at?: string; default_channel?: string; format_e164?: string; format_international?: string; format_national?: string; format_rfc?: string; is_inherited?: boolean; opt_out?: boolean; phone_number?: string; region_code?: string; updated_at?: string; }; error?: { code?: string; details?: object; doc_url?: string; message?: string; }; meta?: { request_id?: string; timestamp?: string; version?: string; }; success?: boolean; }',
    markdown:
      "## update\n\n`client.contacts.update(id: string, default_channel?: string, opt_out?: boolean, sandbox?: boolean, Idempotency-Key?: string, x-profile-id?: string): { data?: object; error?: object; meta?: object; success?: boolean; }`\n\n**patch** `/v3/contacts/{id}`\n\nUpdates a contact's default channel and/or opt-out status. Inherited contacts cannot be updated.\n\n### Parameters\n\n- `id: string`\n\n- `default_channel?: string`\n  Default messaging channel: \"sms\" or \"whatsapp\"\n\n- `opt_out?: boolean`\n  Whether the contact has opted out of messaging. Single source of truth — opt-out is\nper-contact, not per-channel.\n\n- `sandbox?: boolean`\n  Sandbox flag - when true, the operation is simulated without side effects\nUseful for testing integrations without actual execution\n\n- `Idempotency-Key?: string`\n\n- `x-profile-id?: string`\n\n### Returns\n\n- `{ data?: { id?: string; available_channels?: string; country_code?: string; created_at?: string; default_channel?: string; format_e164?: string; format_international?: string; format_national?: string; format_rfc?: string; is_inherited?: boolean; opt_out?: boolean; phone_number?: string; region_code?: string; updated_at?: string; }; error?: { code?: string; details?: object; doc_url?: string; message?: string; }; meta?: { request_id?: string; timestamp?: string; version?: string; }; success?: boolean; }`\n  Standard API response envelope for all v3 endpoints\n\n  - `data?: { id?: string; available_channels?: string; country_code?: string; created_at?: string; default_channel?: string; format_e164?: string; format_international?: string; format_national?: string; format_rfc?: string; is_inherited?: boolean; opt_out?: boolean; phone_number?: string; region_code?: string; updated_at?: string; }`\n  - `error?: { code?: string; details?: object; doc_url?: string; message?: string; }`\n  - `meta?: { request_id?: string; timestamp?: string; version?: string; }`\n  - `success?: boolean`\n\n### Example\n\n```typescript\nimport Sent from '@sentdm/sentdm';\n\nconst client = new Sent();\n\nconst contact = await client.contacts.update('6ba7b810-9dad-11d1-80b4-00c04fd430c8');\n\nconsole.log(contact);\n```",
    perLanguage: {
      typescript: {
      ...
      ruby: {
        method: 'contacts.update',
        example:
          'require "sentdm"\n\nsent = Sentdm::Client.new(api_key: "My API Key")\n\ncontact = sent.contacts.update("6ba7b810-9dad-11d1-80b4-00c04fd430c8")\n\nputs(contact)',
      },
      php: {
        method: 'contacts->update',
        example:
